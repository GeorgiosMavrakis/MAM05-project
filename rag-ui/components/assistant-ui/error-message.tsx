...
export const ErrorMessage: FC<ErrorMessageProps> = ({ content, className }) => {
  return (
    ...
    >
      <div className="aui-error-message-content mx-2 rounded-lg border-l-4 border-destructive bg-destructive/10 p-4 text-destructive dark:bg-destructive/5 dark:text-red-200">
